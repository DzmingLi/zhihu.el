...
(ert-deftest zhihu-browser-cookie-reader-delegates-to-browser-cookies ()
  (let ((zhihu-cookie-browser 'firefox)
        (zhihu-cookie-profile-directory "/profiles/zhihu/")
        called)
      ...
      (should
       (equal
        (zhihu--read-browser-cookies
         "https://www.zhihu.com/api/v4/me?q=full")
        '(("z_c0" . "session")))))
    (should
     (equal called
            '("https://www.zhihu.com/api/v4/me?q=full"
              :browser firefox
              :profile-directory "/profiles/zhihu/")))))
